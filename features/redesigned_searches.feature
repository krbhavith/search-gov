Feature: Search - redesign
  ...
  Scenario: Searching on sites with federal register documents
    And the following Affiliates exist:
      | display_name | name          | contact_email    | first_name | last_name | agency_abbreviation | is_federal_register_document_govbox_enabled | domains  | use_redesigned_results_page | display_created_date_on_search_results | gets_i14y_results | search_engine |
      | English site | en.agency.gov | admin@agency.gov | John       | Bar       | DOC                 | true                                        | noaa.gov | true                        | true                                   | true              | SearchGov     |
